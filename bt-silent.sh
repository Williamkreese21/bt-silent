...
echo -e "${CYN}=========================================${RST}"
echo -e "${WHT}  Command:    sudo bt-silent${RST}"
...
banner() {
    ...
    echo ""
    echo -e "${WHT}      ____  ____  ____  __    __  ______${RST}"
    echo -e "${WHT}     / __ )/ __ \\/ __ \\/ /   / / / / __/${RST}"
    echo -e "${CYN}    / __  / /_/ / / / / /   / /_/ / /_   ${RST}"
    echo -e "${CYN}   / /_/ / ____/ /_/ / /___/ __  / __/   ${RST}"
    echo -e "${BLU}  /_____/_/    \\____/_____/_/ /_/_/      ${RST}"
    echo -e "${RED}         *           *${RST}"
    echo ""
    echo -e "${GRN}**                                   **${RST}"
    echo -e "${RED}=========================================${RST}"
